<?php
/**
 * Accern Custom functions and definitions
 *
...
if ( ! function_exists( 'accern_custom_setup' ) ) :
	 ...
	 */
	function accern_custom_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on Accern Custom, use a find and replace
		 * to change 'accern-custom' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'accern-custom', get_template_directory() . '/languages' );
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'accern-custom' ),
		) );
		...
		add_theme_support( 'custom-background', apply_filters( 'accern_custom_custom_background_args', array(
...
add_action( 'after_setup_theme', 'accern_custom_setup' );
 ...
 */
function accern_custom_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'accern_custom_content_width', 640 );
}
add_action( 'after_setup_theme', 'accern_custom_content_width', 0 );
 ...
 */
function accern_custom_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'accern-custom' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'accern-custom' ),
...
add_action( 'widgets_init', 'accern_custom_widgets_init' );
