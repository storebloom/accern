...
?>
<div data-section="2" id="home-section-2" class="homepage-section">
		...
		<?php foreach ( $section_info['overlay-repeater'] as $num => $overlay_links ) : ?>
			...
			<?php else : ?>
				<div class="section-overlay">
					<a class="accern-overlay-button" data-section="home-section-2" data-num="<?php echo esc_attr( $num ); ?>" id="section-2-overlay-<?php echo esc_attr( $num ); ?>">
						<?php echo esc_html( $overlay_links['title'] ); ?>
					</a>
				</div>
				<?php
