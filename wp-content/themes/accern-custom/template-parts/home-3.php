...
$section_info = get_home_section_info( '3', get_the_ID() );
?>
<div data-section="3" id="home-section-3" class="homepage-section">
		...
		<?php foreach ( $section_info['overlay-repeater'] as $num => $overlay_links ) : ?>
			...
			<?php else : ?>
				<div class="section-overlay">
					<a class="accern-overlay-button" data-section="home-section-3" data-num="<?php echo esc_attr( $num ); ?>" id="section-3-overlay-<?php echo esc_attr( $num ); ?>">
						<?php echo esc_html( $overlay_links['title'] ); ?>
					</a>
				</div>
				<?php
